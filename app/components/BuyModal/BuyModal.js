...
const BuyModal = React.memo(function BuyModal() {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-70 z-50 flex items-end md:items-center justify-center">
      ...
      {/* Modal Container */}
      <div className="relative bg-gray-900 w-full max-w-lg md:max-w-2xl mx-4 md:rounded-2xl overflow-hidden shadow-2xl border border-gray-800 max-h-[90vh] md:max-h-[85vh] flex flex-col">
        
        {/* Mobile Handle Bar (YouTube style) */}
        <div className="md:hidden flex justify-center py-2 bg-gray-900 border-b border-gray-800">
            ...
            <div className="p-4 space-y-6">
              ...
              <div className="bg-gray-800 bg-opacity-50 rounded-xl p-4 border border-gray-700">
                ...
                <div className="flex items-center gap-3">
                  <button 
                    className="w-10 h-10 bg-gray-700 hover:bg-gray-600 border border-gray-600 rounded-lg flex items-center justify-center text-white font-semibold transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed" 
                    onClick={decrement}
                    disabled={count <= 1}
                  >
                    -
                  ...
                  <div className="flex-1 max-w-20">
                    <input
                      ...
                      value={count}
                      readOnly
                      className="w-full text-center bg-gray-800 border border-gray-600 rounded-lg px-3 py-2 text-white font-medium outline-none"
                    />
                  </div>
                  <button
                    className="w-10 h-10 bg-gray-700 hover:bg-gray-600 border border-gray-600 rounded-lg flex items-center justify-center text-white font-semibold transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
