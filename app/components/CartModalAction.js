...
export default function CartModalAction({ id, stock }) {
  ...
  return (
    <button
      onClick={handleAdd}
      className="w-full group relative overflow-hidden bg-gray-800 hover:bg-gray-700 border border-gray-600 hover:border-gray-500 text-white py-3 px-6 rounded-lg font-medium transition-all duration-300 transform hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl"
    >
