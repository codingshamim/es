          ...
          <table className="w-full">
            <thead className="bg-gray-900/50 border-b border-gray-700">
              <tr>
                ...
                <th className="text-left p-4 font-medium text-gray-300">Total</th>
            ...
            <tbody className="divide-y divide-gray-800">
              {orders.map((order) => (
                <tr key={order.id} className="hover:bg-gray-900/30 transition-colors">
                  <td className="p-4">
                    <div className="font-medium text-purple-400">#{order.id}</div>
                  ...
                  <td className="p-4">
                    <div className="flex items-center space-x-2">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-gray-500">{order.additionalItems}</div>
                      </div>
                    </div>
                  </td>
                  <td className="p-4">
                  ...
                  <td className="p-4">
                    <span className={`px-2 py-1 rounded-full text-xs font-medium border ${getStatusStyle(order.statusColor)}`}>
                      {order.status}
                    </span>
                  </td>
                  <td className="p-4">
